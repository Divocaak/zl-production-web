export const load = () => {
    return {
        hero: {
            ...
            tagline: 'Jak se stavěl Majáles v Ostravě?',
            videoSrc: "/videos/majales-ostrava/majales-ostrava_master.m3u8"
        },
        textBeforeStats: [
            ...
            `Pro projekty připravujeme <span>vlastní návrhy scén</span> a řešení stage designu, doplněné o obsah ve formě videokontentu, speciálních efektů, programování osvětlení a efektů. Vítáme možnost řízení obsahu timecodem, což umožňuje vytváření individualizovaných show pro každý projekt podle specifik vyplývajících z charakteru nebo záměru akce. Kromě přípravné fáze se samozřejmě věnujeme také <span>kompletní realizaci</span> na místě konání a dodání všech potřebných služeb a materiálu.`
        ],
        stats: {
        ...
        textAfterStats: [
            `Největší kreativní prostor nám poskytuje náš <i>druhý domov</i>, O2 arena. Realizovali jsme zde (od prvních návrhů až po technické řešení a odbavení) akce jako <span>Vánoce v květnu</span> (Kryštof), vyprodané koncerty <span>Marka Ztraceného</span>, netradiční estrádu <span>Kapitána Dema</span> a speciality jako <span>Korncert</span> Jiřího Korna či přelomovou show <span>světových parametrů</span> metalových <span>Dymytry</span>.`,
            `Technologie a know-how využíváme nejen pro běžný koncertní svět, ale i pro korporátní a firemní eventy s kompletním designem prostoru, nejen podia.`,
